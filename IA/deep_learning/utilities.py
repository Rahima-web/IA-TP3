...
def get_dataset(currency="BTC"):
    folder_path = "/Users/rahimamohamed/Desktop/Predict-Cryptocurrency-Price-With-Machine-Learning-master/CryptoAI-CoinMarketCapHistoricalDataScraper/%s.csv" % currency
